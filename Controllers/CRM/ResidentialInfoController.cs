...
namespace Adroit_v8.Controllers.CRM
{
    ...
    [ApiController]
    [Authorize]
    public class ResidentialInfoController :AuthController
    {
        private readonly IMongoRepository<ClientResidentialInfo> _repo;
        ...
        string _CreatedBy = "0";
        public ResidentialInfoController(IMongoRepository<ClientResidentialInfo> repo, 
        ...
        public async Task<IActionResult> Add([FromBody] ClientResidentialInfoFm obj)
        {
            ...
            try
            {
                ClientResidentialInfo la = new()
                {
                    ...
                    ResidentialStatus = obj.ResidentialStatus,
                    NoOfYearsAtResidence = obj.NoOfYearsAtResidence,
                ...
                {
                    CustomerId = obj.CustomerId,
                    StageId = CustomerRegistrationStage.StageResidentialInfo.ToString()
                };
        ...
        [SwaggerResponse(StatusCodes.Status500InternalServerError, Type = typeof(ReturnObject))]
        [Route("Update")]
        public async Task<IActionResult> Update([FromBody] ClientResidentialInfoUpdateFm obj)
        {
            var RequestTime = DateTime.UtcNow;
            string actionUrl = $"{ControllerContext.RouteData.Values["controller"]}/{ControllerContext.RouteData.Values["action"]}";
            try
