...
namespace Adroit_v8.Controllers.LoanUnderwriting
{
    ...
    public class ApprovalController : AuthController
    {
      ...
      [HttpGet][CustomAuthorizeAttribute(AllForms.Approval, FormPermissions.CanView)]
      ...
      [HttpGet][CustomAuthorizeAttribute(AllForms.Approval, FormPermissions.CanView)]
        ...
        public async Task<IActionResult> GetByCustomerId([FromRoute] string loanId)
        {
            var r = new ReturnObject();
            try
            {
                var res = _repo.AsQueryable().FirstOrDefault(o => o.LoanApplicationId == loanId && o.Status == (int)AdroitLoanApplicationStatus.Approved);
                if (res != null)
                {
        ...
        [HttpPost]
        [CustomAuthorizeAttribute(AllForms.Approval, FormPermissions.CanAdd)]
        ...
        [HttpPost][CustomAuthorizeAttribute(AllForms.Approval, FormPermissions.CanAdd)]
        [SwaggerResponse(StatusCodes.Status200OK, Type = typeof(ReturnObject))]
        [SwaggerResponse(StatusCodes.Status500InternalServerError, Type = typeof(ReturnObject))]
        [Route("getComments")]
        ...
        [HttpPut]
        [CustomAuthorizeAttribute(AllForms.Approval, FormPermissions.CanUpdate)]
