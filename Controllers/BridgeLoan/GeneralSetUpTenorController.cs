...
namespace Adroit_v8.Controllers.BridgeLoan
{
    ...
    [ApiController]
    [Authorize]
    public class GeneralSetUpTenorController :AuthController
    {
        private readonly IMongoRepository<GeneralSetUpTenor> _repo;
        string errMsg = "Unable to process request, kindly try again";
       // string _CreatedBy = "0";
        public GeneralSetUpTenorController(IMongoRepository<GeneralSetUpTenor> repo, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {
            _repo = repo;
        }
        ...
        [NonAction]
        private List<GeneralSetUpTenor> Get()
        {
