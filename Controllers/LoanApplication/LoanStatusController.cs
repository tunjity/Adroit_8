...
namespace Adroit_v8.Controllers.LoanApplication
{
    ...
    [ApiController]
    [Authorize]
    public class LoanStatusController :AuthController
    {
        private readonly IMongoRepository<LoanStatus> _repo;
        string errMsg = "Unable to process request, kindly try again";
        public LoanStatusController(IMongoRepository<LoanStatus> repo,IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {
            _repo = repo;
        }
