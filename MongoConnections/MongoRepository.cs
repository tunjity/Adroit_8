...
namespace Adroit_v8.MongoConnections
{
    ...
    public class MongoRepository<TBaseDto> : IMongoRepository<TBaseDto>
    where TBaseDto : IBaseDto
    {
        ...
        public MongoRepository(IConfiguration config, IHttpContextAccessor httpContextAccessor)
        {
        ...
        ReturnObject IMongoRepository<TBaseDto>.InsertOne(TBaseDto document)
        {
    ...
    /// <summary>
    /// ///////////////////ICustomerCentricRepository
    /// </summary>
    /// <typeparam name="TBaseDto"></typeparam>
    public interface ICustomerCentricRepository<TBaseDto> where TBaseDto : IBaseDtoForCC
    {
        IQueryable<TBaseDto> AsQueryable();
        IEnumerable<TBaseDto> FilterBy(
            Expression<Func<TBaseDto, bool>> filterExpression);
    ...
    public class CustomerCentricRepository<TBaseDto> : ICustomerCentricRepository<TBaseDto>
    where TBaseDto : IBaseDtoForCC
    {
        private readonly IMongoCollection<TBaseDto> _collection;
        private readonly IConfiguration _config;

        public CustomerCentricRepository(IConfiguration config)
        {
            _config = config;
        ...
        //public async IQueryable<Customer> GetCustomersForChecker()
        //{
        //    var r= _collection.GetCollection<Employee>()
        //                      .AsQueryable()
